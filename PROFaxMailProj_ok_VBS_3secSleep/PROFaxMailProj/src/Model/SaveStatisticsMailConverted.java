...
public class SaveStatisticsMailConverted {
    ...
    public void recuperaFoglioStatistiche() throws IOException {
        fis = fl.getFileInputStream("C:\\Users\\user\\Documents\\Risorse_Software\\FaxMailProjectATHome\\Statistiche\\Statistics.xlsx");
    ...
    public void compilaExcelStatistiche(int numeroRapportiCreati) throws IOException {
      ...
      /*  sh.createRow(ultiamRiga+1);
        ...
        fos = new FileOutputStream("C:\\Users\\user\\Documents\\Risorse_Software\\FaxMailProjectATHome\\Statistiche\\Statistics.xlsx");
        wb.write(fos);
