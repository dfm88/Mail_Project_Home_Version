...
public class XlsToPDF {
    ...
    public void writeNewScript(String percorsoOrigineExcel, String percorsoDestinazionePDF) throws IOException
    {
        ...
        File macro = new File("");
        setPercorsoMacro(macro.getAbsolutePath()+"\\PROFaxMailProj\\src\\ExcelToPDFConverter\\macro.vbs"); // C:-Users-user-Documents-PROFaxMailProj++\ExcelToPFDConverter\macro.vbs
